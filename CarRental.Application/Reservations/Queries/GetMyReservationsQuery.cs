...
{
    public record GetMyReservationsQuery(int? Offset, int? Limit)
        : IRequest<ApplicationResult<IEnumerable<ReservationResponse>>>;

    public class GetMyReservationsQueryHandler(
        ILogger<GetMyReservationsQueryHandler> logger,
        IUserContext userContext,
        IReservationsRepository reservationsRepository)
        : IRequestHandler<GetMyReservationsQuery, ApplicationResult<IEnumerable<ReservationResponse>>>
    {
            ...
            GetMyReservationsQuery query, CancellationToken cancellationToken)
        {
            ...
            logger.LogInformation("Fetched {Count} reservation(s) for user {UserId}.", reservations.Count, currentUser.Id);
