...
namespace CarRental.Application.Identity.Commands
{
    ...
    : IRequestHandler<LoginWebCommand, Result<LoginResponse>>
    {
        public async Task<Result<LoginResponse>> Handle(LoginWebCommand command, CancellationToken cancellationToken)
        {
            ...
            if (user.TwoFactorEnabled)
            {
                ...
                return Result<LoginResponse>.Success(new LoginResponse(Requires2FA: true));
            }
